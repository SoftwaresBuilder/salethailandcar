...
if(isset($_GET['id']))
{
    ...
    $record = get_records($tblcategory_submodels,"id='".$id."'");
    if(isset($record[0])){
    ...
    $_SESSION['sysData'] = table_fields($tblcategory_submodels);
}

?>
<form action="process.php?p=addeditsubmodels" enctype="multipart/form-data" method="post">
<div class="row">
    <div class="col-md-12">
        <div class="card">
            
                <div class="header">
                    <h4 class="title">Add/Edit SubModels</h4>
                </div>
                <?php show_errors();?>
                <div class="row">
