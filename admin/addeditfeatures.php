...
if(isset($_GET['id']))
{
    ...
    $record = get_records($tblcategory_features,"id='".$id."'");
    if(isset($record[0])){
    ...
    $_SESSION['sysData'] = table_fields($tblcategory_features);
}
$cid = dec_password($_GET['cid']);
?>
<form action="process.php?p=addeditfeatures" enctype="multipart/form-data" method="post">
<div class="row">
    <div class="col-md-12">
        <div class="card">
            
                <div class="header">
                    <h4 class="title">Add/Edit Features</h4>
                </div>
                <?php show_errors();?>
                <div class="row">
