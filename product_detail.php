  ...
  <div class="col-12 col-md-4">
      ...
      <div class="col-12 border_bottom">
        <div class="row">
          ...
          <div class="col-10">
            ...
            By <a href="vendor_profile.php?id=<?=enc_password($get_user_detail[0]['id']);?>">

              <?php echo $get_user_detail[0]['name']; ?></a><br>
    ...
    <h3 class="light-text-0 ui-block-title" style="position: fixed;background-color: white;z-index: 999;width: inherit">
             <span class="user-image round-img header-img">
                        <img src="images/profile-placeholder.jpg" alt="DDDavid">
              </span>
        <a class="light-text-1 text-capitalize" href="/user/index">
            david david            <i class="fa fa-angle-double-right"></i>
        </a>
