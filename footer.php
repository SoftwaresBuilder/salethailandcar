            ...
            <div class="row section_spacer">
                <div class="col-12 col-md-5">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <input type="button" class="btn btn-primary" name="" value="READ MORE ABOUT US">
                        </div>
                    </div>
                </div>
    ...
    <div class="log_sign_bx">
        <div class="top_social">
            <div id="google_facebook">
                <div id="w2">
                    <div class="row">
                        <div class="col pr-2"><a class="custom-btn facebook auth-link" href="/site/auth?authclient=facebook" title="Facebook" data-popup-width="860" data-popup-height="480"><span><i class="icofont-facebook"></i> FACEBOOK</span> </a> </div>
                        <div class="col pr-2"><a class="custom-btn google auth-link" href="/site/auth?authclient=google" title="Google"><span><i class="fa fa-google"></i> GOOGLE</span> </a> </div>
                    </div>
                </div>
            </div>
                ...
                function show_radio_val(str) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            type: type_filter,
                            cat_val: cat_val,
                            p: 'get_real_estate_type'
                        },
                        success: function(data) {
                            $('#serach_results').html('');
                            $('#serach_results').html(data);

                            document.getElementById('serach_results').scrollIntoView({
                                block: 'start',
                                behavior: 'smooth'
                            });
