...
if(isset($_GET['id']))
{
    ...
    $record = get_records($tblcategory_models,"id='".$id."'");
    if(isset($record[0])){
    ...
    $_SESSION['sysData'] = table_fields($tblcategory_models);
}

?>
<form action="process.php?p=addeditmodels" enctype="multipart/form-data" method="post">
<div class="row">
    <div class="col-md-12">
        <div class="card">
            
                <div class="header">
                    <h4 class="title">Add/Edit Models</h4>
                </div>
                <?php show_errors();?>
                <div class="row">
